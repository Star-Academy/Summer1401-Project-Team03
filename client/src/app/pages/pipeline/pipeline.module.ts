...
import {SettingItemModalComponent} from './components/process-list/components/setting-item-modal/setting-item-modal.component';
...
@NgModule({
    ...
    imports: [CommonModule, SvgModule, LoadingButtonModule, ButtonModule, ModalModule, NgxDraggabillyModule, AngularDraggableModule],
})
